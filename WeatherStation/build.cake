...
var destinationIp = Argument("destinationPi", "172.17.25.64"); //192.168.1.87 dom 172.17.25.64 praca
var destinationDirectory = Argument("destinationDirectory", @"/home/pi/apps/WeatherStation");
var username = Argument("username", "pi");
var sessionname = Argument("sessionname", "Work_Prezka");
var executableName = Argument("executableName", "WeatherStation");
